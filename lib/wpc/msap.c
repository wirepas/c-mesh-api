                                      ...
                                      uint8_t *const payload_size)
{
    ...
    if (confirm.payload.sap_generic_confirm_payload.result == 0)
    {
        memcpy(payload,
               ...
               confirm.payload.msap_config_data_item_get_confirm_payload.payload_length);
        *payload_size = confirm.payload.msap_config_data_item_get_confirm_payload.payload_length;
    }
