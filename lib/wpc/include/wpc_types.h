...
//Max slip frame size (can be 2 times bigger than a frame if every bytes are escaped)
#define MAX_SLIP_FRAME_SIZE        (2*MAX_FRAME_SIZE)

//Define the function type to handle a received frame from the stack (confirm or indication)
