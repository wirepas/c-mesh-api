...
typedef struct _wp_UploadScratchpadReq_ChunkInfo {
    ...
    uint32_t scratchpad_total_size;
...
#define wp_UploadScratchpadReq_ChunkInfo_init_default {0, 0}
...
#define wp_UploadScratchpadReq_ChunkInfo_init_zero {0, 0}
...
#define wp_UploadScratchpadReq_ChunkInfo_scratchpad_total_size_tag 1
#define wp_UploadScratchpadReq_ChunkInfo_start_offset_tag 2
...
X(a, STATIC,   REQUIRED, UINT32,   scratchpad_total_size,   1) \
X(a, STATIC,   REQUIRED, UINT32,   start_offset,      2)
